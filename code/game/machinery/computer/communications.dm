...
/proc/init_shift_change(var/mob/user, var/force = 0)
	...
	if(!force)
		...
		if(world.time < (54000*3)) // 90 minute grace period to let the game get going
			user << "The shuttle is refueling. Please wait another [round(((54000*3)-world.time)/600)] minutes before trying again."//may need to change "/600"
			return
