...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if("blood pact soldier")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/warhammer/BPact(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/warhammer/bloodpact(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/warhammer/BPact(M), slot_head)
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/cell/(M), slot_l_store)
			M.equip_to_slot_or_del(new /obj/item/weapon/cell/(M), slot_r_store)
			M.equip_to_slot_or_del(new /obj/item/weapon/spade(M), slot_belt)

		if("blood pact support")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/warhammer/BPact(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/warhammer/bloodpact(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/laser(M), slot_in_backpack)
		...
		if("blood pact sergeant")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/warhammer/bloodpact_sgt(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(M), slot_gloves)
		...
		if("krieg soldier")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/warhammer/krieg(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/warhammer/khelmet(M), slot_head)
		...
		if("krieg sergeant")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/warhammer/krieg(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/warhammer/krieg_sgt(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(M), slot_gloves)
		...
		if("blood pact commisar")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/hos(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/HoS(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/weapon/spade(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/laser/captain(M), slot_r_hand)
			M.equip_to_slot_or_del(new /obj/item/device/radio(M), slot_l_store)
			M.equip_to_slot_or_del(new /obj/item/weapon/melee/baton(M), slot_l_hand)

		if("krieg commisar")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/warhammer/krieg(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/warhammer/krieg_com(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/warhammer/khelmet(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/weapon/spade(M), slot_belt)
