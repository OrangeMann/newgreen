...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if("blood pact soldier")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
		//	M.equip_to_slot_or_del(new /obj/item/device/radio/headset(M), slot_ears)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/warhammer/BPact(M), slot_head)
		...
		if("blood pact sergeant")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/warhammer/BPact_serg(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/warhammer/bloodpact_sgt(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
		//	M.equip_to_slot_or_del(new /obj/item/device/radio/headset(M), slot_ears)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/warhammer/BPact_sgt(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/BPmask(M), slot_wear_mask)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack(M), slot_back)
		...
		if("krieg officer")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
		//	M.equip_to_slot_or_del(new /obj/item/device/radio/headset(M), slot_ears)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/warhammer/khelmet(M), slot_head)
		...
		if("krieg sergeant")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/hos(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/warhammer/khelmet_sgt(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/krieg(M), slot_wear_mask)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/laser(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/cell(M), slot_in_backpack)
