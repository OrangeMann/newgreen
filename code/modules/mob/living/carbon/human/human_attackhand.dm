			...
			if(M.a_intent == "hurt")//Stungloves. Any contact will stun the alien.
				if(G.cell.charge >= 2500)
					...
					if(M != src)
						...
						msg_admin_attack("[M] ([M.ckey])(<A HREF='?_src_=holder;adminplayerobservejump=\ref[src]'>JMP</A>) stungloved [src] ([src.ckey]).", 0)
						...
						//log_admin("ATTACK: [src] ([src.ckey]) stungloved [M] ([M.ckey]).")
						msg_admin_attack("[src] ([src.ckey])(<A HREF='?_src_=holder;adminplayerobservejump=\ref[src]'>JMP</A>) stungloved [gender_text].", 0)
					...
					if(M != src)
						visible_message("\red <B>[src] has been touched with the stun gloves by [M]!</B>")
						msg_admin_attack("[M] ([M.ckey](<A HREF='?_src_=holder;adminplayerobservejump=\ref[src]'>JMP</A>) was trying to stunglove [src] ([src.ckey]).", 0)
						log_attack("[M] ([M.ckey] was trying to stunglove [src] ([src.ckey])")
					else
						visible_message("\red <B>[src] has been touched with the stun gloves by \himself!</B>")
						msg_admin_attack("[src] ([src.ckey])(<A HREF='?_src_=holder;adminplayerobservejump=\ref[src]'>JMP</A>) was trying to stunglove [gender_text].", 0)
...
//			if(M.health < -75)	return 0
		...
		if("disarm")
			if (M != src)
				...
				msg_admin_attack("[M.name] ([M.ckey])(<A HREF='?_src_=holder;adminplayerobservejump=\ref[M]'>JMP</A>) disarmed [src.name] ([src.ckey])",0)
				...
				msg_admin_attack("[src.name] ([src.ckey])(<A HREF='?_src_=holder;adminplayerobservejump=\ref[src]'>JMP</A>) disarmed [gender_text]",0)
