...
#define HEAT_DAMAGE_LEVEL_3 6 //Amount of damage applied when your body temperature passes the 1000K point
...
#define HEAT_GAS_DAMAGE_LEVEL_2 3 //Amount of damage applied when the current breath's temperature passes the 400K point
#define HEAT_GAS_DAMAGE_LEVEL_3 6 //Amount of damage applied when the current breath's temperature passes the 1000K point
