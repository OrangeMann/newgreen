...
/obj/item/weapon/reagent_containers/backpack/water
	name = "water kit"
	desc = "A portable water carrier."
	icon_state = "waterpack"

/obj/item/weapon/reagent_containers/backpack/water/New()
	..()
	reagents.add_reagent("water", volume)


/obj/item/weapon/reagent_containers/backpack/cleaner
	name = "cleaner kit"
